...
public class FileChooserLoadKey extends FileChooserButton implements FileChooserEvent {
    SymmetricCipherSection section;

    public FileChooserLoadKey(SymmetricCipherSection section, String text, ImageIcon icon) {
        super(text, icon);
